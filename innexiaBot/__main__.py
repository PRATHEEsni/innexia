...
INNEXIA_IMG = "https://telegra.ph/file/c1169cca4e16d92d5ccdf.jpg"

PM_START_TEXT = """
[ ](https://telegra.ph/file/914610635d34c0d5a8ba1.jpg) `Heya` 💖 `I am` **Eʟɪɴᴀ </> ガマ丸** `Your Group Super Bot`
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", url="t.me/pratheek06")]]
            ),
        )
...
def innexia_about_callback(update, context):
    ...
    if query.data == "innexia_":
        query.message.edit_text(
            ...
            \nHere's the basic help regarding use of Elina.
        ...
        query.message.edit_text(
            ...
            f"\n• Than send `/admincache@ElinaBaby_Bot` in that chat to refresh admin list in My database.\n"
        ...
        query.message.edit_text(
            ...
            f"\nCongragulations, Eʟɪɴᴀ </> ガマ丸 now ready to manage your group."
            f"\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            ...
            f"\nHere Some Developers Helping in Making The Eʟɪɴᴀ </> ガマ丸 Bot",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..💕 I'm *Eʟɪɴᴀ </> ガマ丸*
                 \nHere is the [🥀 Oᴡɴᴇʀ](https://t.me/pratheek06) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Iᴀᴍ Aʟɪᴠᴇ Bᴜᴅᴅʏ ⏳")
        except Unauthorized:
            LOGGER.warning(
